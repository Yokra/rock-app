...
function showSingleContacts(contacts) {
    ...
    //copy.querySelector(".contact").textContent = contacts.title.rendered;
    ...
    copy.querySelector(".contactimage").src = contacts._embedded["wp:featuredmedia"][0].media_details.sizes.medium.source_url;
